...
void runAll(int32_t num_count, int32_t print){
    ...
    printf("Quick sortu je trebalo: %" PRIu64 "ms\n", end - start);    
    ...
    printf("Shell sortu je trebalo: %" PRIu64 "ms\n", end - start);
    ...
    printf("Merge sortu je trebalo: %" PRIu64 "ms\n", end - start);
    ...
    printf("Bubble sortu je trebalo: %" PRIu64 "ms\n", end - start);
   ...
   // Inesertion sort
    ...
    printf("Insertion sortu je trebalo: %" PRIu64 "ms\n", end - start);
    ...
    printf("Exchange sortu je trebalo: %" PRIu64 "ms\n", end - start);
    ...
    printf("Selection sortu je trebalo: %" PRIu64 "ms\n", end - start);
